...
# partial derivates of the multiplication, the chain rule
dsum_dxw0 = 1
dsum_dxw1 = 1
dsum_dxw2 = 1
dsum_db = 1
drelu_dwx0 = drelu_dz * dsum_dxw0
drelu_dwx1 = drelu_dz * dsum_dxw1
drelu_dwx2 = drelu_dz * dsum_dxw2
drelu_db = drelu_dz * dsum_db
print(drelu_dwx0, drelu_dwx1, drelu_dwx2, drelu_db)
